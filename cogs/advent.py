...
class Advent(commands.Cog):
    def __init__(self, client: commands.Bot):
        ...
        self.gifts = {
            ...
            10: {"action": self.gift_action_3, "description": "🎄 Christmas coins"},
            11: {"action": self.gift_action_3, "description": "🐉 Ninjonik stolen goods"},
            12: {"action": self.gift_action_3, "description": "🐉 idk what tu put there"},
            13: {"action": self.gift_action_3, "description": "🎅 idk what to put there"},
            14: {"action": self.gift_action_2, "description": "🎄 Festive cookies"},
            15: {"action": self.gift_action_3, "description": "🎅 Santa Coins"},
            ...
            22: {"action": self.gift_action_3, "description": "👑 WWC Gold Reserves Part 2"},
            23: {"action": self.gift_action_nothing, "description": "Come back tomorrow!"},
            24: {"action": self.gift_action_1, "description": "🎄🎅🛷 WISH ANYTHING ACCEPTABLE AND IT MAY COME TRUE! ("
                                                              "within the server)"},
        }
